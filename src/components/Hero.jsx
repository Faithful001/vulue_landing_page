...
const Hero = () => {
	return (
		<div className="hero flex justify-between pt-[4rem] items-center bg-black h-full">
			<div className="flex flex-col justify-between py-20 mx-10 -mt-10">
				...
				<div>
					<button className="bg-[#0170E3] text-sm rounded-md p-3 mb-2 px-7">
						Start investing
					</button>
